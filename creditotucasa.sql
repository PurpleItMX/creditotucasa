...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 20-11-2018 a las 20:36:58
...
--
ALTER TABLE `credit_types`
  MODIFY `id_credit_type` int(10) UNSIGNED NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT de la tabla `houses`
--
ALTER TABLE `houses`
  MODIFY `id_house` int(10) UNSIGNED NOT NULL AUTO_INCREMENT;
